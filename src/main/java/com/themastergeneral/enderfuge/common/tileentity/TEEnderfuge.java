...
public class TEEnderfuge extends TileEntity implements ITickable, ISidedInventory
{
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TEEnderfuge.class, new String[] {"Items"}));
    }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = EnderfugeRecipes.instance().getSmeltingResult((ItemStack)this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = EnderfugeRecipes.instance().getSmeltingResult(itemstack);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        {
            ItemStack itemstack = (ItemStack)this.furnaceItemStacks.get(1);
            return isItemFuel(stack) || SlotEnderfugeFuel.isBucket(stack) && itemstack.getItem() != Items.BUCKET;
        }
    }
