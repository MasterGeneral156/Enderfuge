...
public class TEEnderfuge extends TileEntity implements ITickable, ISidedInventory
{
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists("enderfuge", new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockEnderfuge.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = EnderfugeRecipes.instance().getSmeltingResult(this.furnaceItemStacks[0]);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        else
        {
            ...
            return isItemFuel(stack) || SlotEnderfugeFuel.isBucket(stack) && (itemstack == null || itemstack.getItem() != Items.BUCKET);
        }
    }
