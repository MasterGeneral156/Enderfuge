...
public class IC2Integration {
	...
	public static void loadRecipes() {
		Integration
				.addSmeltingRecipe(
						new ItemStack(StackHelper
								...
								StackHelper.itemFromRegistryName("ic2:ingot"), 2,
								1), 0.7F);
		Integration
				.addSmeltingRecipe(
						new ItemStack(StackHelper
		...
		Integration
				.addSmeltingRecipe(
						new ItemStack(StackHelper
								...
								OreDictionary.WILDCARD_VALUE), new ItemStack(
								StackHelper.itemFromRegistryName("ic2:ingot"), 1,
								1), 0.7F);
		Integration
				.addSmeltingRecipe(
						new ItemStack(StackHelper
								...
								OreDictionary.WILDCARD_VALUE), new ItemStack(
								StackHelper.itemFromRegistryName("ic2:ingot"), 3,
								1), 0.7F);
		Integration
				.addSmeltingRecipe(
						new ItemStack(StackHelper
		...
		Integration.addSmeltingRecipe(
				new ItemStack(StackHelper.itemFromRegistryName("ic2:bronze_axe"),
						1, OreDictionary.WILDCARD_VALUE), new ItemStack(
						StackHelper.itemFromRegistryName("ic2:ingot"), 2, 1),
				0.7F);
		Integration.addSmeltingRecipe(
				new ItemStack(StackHelper.itemFromRegistryName("ic2:bronze_hoe"),
						1, OreDictionary.WILDCARD_VALUE), new ItemStack(
						StackHelper.itemFromRegistryName("ic2:ingot"), 1, 1),
				0.7F);
		Integration
				.addSmeltingRecipe(
						new ItemStack(StackHelper
		...
		Integration.addSmeltingRecipe(
				new ItemStack(StackHelper.itemFromRegistryName("ic2:nano_boots"),
						1, OreDictionary.WILDCARD_VALUE), new ItemStack(
						StackHelper.itemFromRegistryName("ic2:crafting"), 2, 15),
				0.7F);
		Integration.addSmeltingRecipe(
				new ItemStack(StackHelper
						.itemFromRegistryName("ic2:nano_chestplate"), 1,
						OreDictionary.WILDCARD_VALUE),
				new ItemStack(StackHelper.itemFromRegistryName("ic2:crafting"),
						3, 15), 0.7F);
		Integration.addSmeltingRecipe(
				new ItemStack(
						StackHelper.itemFromRegistryName("ic2:nano_helmet"), 1,
						OreDictionary.WILDCARD_VALUE),
				new ItemStack(StackHelper.itemFromRegistryName("ic2:crafting"),
						2, 15), 0.7F);
		Integration.addSmeltingRecipe(
